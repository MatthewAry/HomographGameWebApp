<template lang="pug">
  div.hello
    ...
    mu-dialog(:open="getHomographDialog", title="Game Settings", @close="close")
      ui-select(hasSearch='true', label='What is your Native Language?', :options="languages", v-model="chosenLanguage")
  ...
  export default {
    ...
    methods: {
      ...
      getHomograph () {
        ...
        this.getHomographDialog = false
        this.clear()
        this.$http.post('https://byui-homograph.appspot.com/getHomograph', {
